export async function parseProtocolFile(file) {
...
async function parseJsonProtocol(file) {
...
async function parsePdfProtocol(file) {
...
async function parseDocxProtocol(file) {
    // For now, we'll just return basic file info
